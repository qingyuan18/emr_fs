...
from emr_fs import feature, training_dataset_feature, client, util
from emr_fs.storage_connector import StorageConnector
...
class Engine:
    ...
    def profile(
        ...
        return (
            self._jvm.com.logicalclocks.emr_fs.engine.SparkEngine.getInstance().profile(
                dataframe._jdf,
                relevant_columns,
                correlations,
                histograms,
    ...
    def validate(self, dataframe, expectations):
        ...
        for expectation in expectations:
            ...
            for rule in expectation.rules:
                rules.append(
                    self._jvm.com.logicalclocks.emr_fs.metadata.validation.Rule.builder()
                    .name(
                        self._jvm.com.logicalclocks.emr_fs.metadata.validation.RuleName.valueOf(
                            rule.get("name")
                        )
                    )
                    .level(
                        self._jvm.com.logicalclocks.emr_fs.metadata.validation.Level.valueOf(
                            rule.get("level")
                        )
                    )
                    ...
                    .acceptedType(
                        self._jvm.com.logicalclocks.emr_fs.metadata.validation.AcceptedType.valueOf(
            ...
            expectation = (
                self._jvm.com.logicalclocks.emr_fs.metadata.Expectation.builder()
        ...
        return self._jvm.com.logicalclocks.emr_fs.engine.DataValidationEngine.getInstance().validate(
