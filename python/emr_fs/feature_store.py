...
from emr_fs.core import transformation_function_engine
    ...
    def sql(
        ...
        Args:
            ...
            read_options (Optional[dict], optional): Additional options to pass to the execution engine. Defaults to {}.
                ...
                this instructs the library to use the `host` parameter in the [`emr_fs.connection()`](project.md#connection) to establish the connection to the online feature store.
